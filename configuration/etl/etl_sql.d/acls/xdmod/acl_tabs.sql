...
-- PURPOSE:   Provide initial population of the acl_tabs table. This file was
--            created by manually processing the roles.json file. In particular
--            going through the 'permitted_modules' sections for each role.
-- =============================================================================
-- mgr acl tabs
