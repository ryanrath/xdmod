                                         ...
                                         SELECT
                                             ...
                                             CONCAT(DATE(DATE_ADD(DATE_ADD(date, INTERVAL 1 YEAR), INTERVAL
                                                                  timestampdiff(day, DATE(concat(
                                                                      year(DATE_ADD(date, INTERVAL 1 YEAR)), '-',
                                             ...
                                             timestampdiff(day, DATE(concat(year(DATE_ADD(date, INTERVAL 1 YEAR)), '-',
                                                                            month(DATE_ADD(date, INTERVAL 1 YEAR)),
                                                                            '-01')) /* beginning date */, date_add(
                                             ...
                                             UNIX_TIMESTAMP(DATE_ADD(
                                                 DATE(CONCAT(DATE_ADD(date, INTERVAL 1 YEAR), ' 23:59:59')), INTERVAL
                                                 timestampdiff(day,
                                                               DATE(concat(year(DATE_ADD(date, INTERVAL 1 YEAR)), '-',
                                                                   ...
                                                                   concat(year(DATE_ADD(date, INTERVAL 1 YEAR)), '-',
                                                                          month(DATE_ADD(date, INTERVAL 1 YEAR)),
                                                                          '-01'), INTERVAL 1 YEAR) /* end date*/
                                                 )
                                                 DAY))                                                                  as year_end_ts,
                                             UNIX_TIMESTAMP(CONCAT(
                                                 DATE(DATE_ADD(DATE_ADD(date, INTERVAL 1 YEAR), INTERVAL
                                                               timestampdiff(day, DATE(concat(
                                                                   year(DATE_ADD(date, INTERVAL 1 YEAR)), '-',
                                                                   month(DATE_ADD(date, INTERVAL 1 YEAR)),
                                                                   '-01')) /* beginning date */, date_add(concat(
