            ...
            return {
                isExceptionReport: function (t) {
                    ...
                    for (i = 0; i < exceptionReports.length; i++) {
                        if (exceptionReports[i].type === t) {
                            return exceptionReports[i];
                        }
                    }
        ...
        var queueGrid = new Ext.grid.GridPanel(
            {
                ...
                columns: [
                    ...
                    },
                    {
                        header: 'Derived From',
                        width: 100,
                        dataIndex: 'creation_method',
                        sortable: true
                    },
                    {
                        header: 'Schedule',
                        width: 70,
                        dataIndex: 'report_schedule',
                        sortable: true
                    },
                    {
                        ...
                        sortable: true,
                        renderer: reportFormatColumnRenderer
                    },
                    {
                        header: '# Charts',
                        width: 70,
                        ...
                        sortable: true,
                        renderer: numChartsColumnRenderer
                    }
                ]
            }
        ); // queueGrid
            ...
            conn.request(
                {
                    ...
                    callback: function (options, success, response) {
                        ...
                        if (success) {
                            ...
                            CCR.xdmod.ui.presentFailureResponse(
                                response,
                                {
                                    title: 'Report Pool',
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                handler: function () {
                                    ...
                                    queueGrid.getStore().each(
                                        function (rec) {
                                            if (map[rec.id] === undefined) {
                                                pendingSelections.push(rowIndex);
                                            }
                                            rowIndex++;
                                        }
                                    );
