...
$config = array(
    ...
    'certdir' => '/data/www/xdmod/etc/simplesamlphp/cert/',
    'loggingdir' => 'log/',
    'datadir' => 'data/',
     ...
     */
    'secretsalt' => 'its@s3crett03veryone',
     ...
     */
    'technicalcontact_name' => 'XMS Team',
    'technicalcontact_email' => 'ccr-xdmod-help@buffalo.edu',
    ...
    */
    ...
    'metadata.sources' => array(
        array(
            'type' => 'flatfile',
            'directory' => '/data/www/xdmod/etc/simplesamlphp/metadata/'
        ),
    ),
