...
then
    ...
    # Make sure that we have the new apache.conf file in place, this can be removed with the 11.5 image update as it will already be in place.
    copy_template_httpd_conf

    # Restart so that the above changes to the apache.conf takes effect.
